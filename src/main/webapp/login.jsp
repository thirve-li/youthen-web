...
<div class="htmleaf-container">
	<div id="wrapper" class="login-page">
	  <p class="center">易理家后台</p>
	  <div id="login_form" class="form">
		<form class="login-form" name="loginForm" id="loginForm" action="j_spring_security_check" method="post" >
		  <input type="text" placeholder="用户名" name="j_username" id="j_username"/>
		  ...
		  <div style="color:red;text-align:center" id="infTip">
			  <c:if test="${AUTHENTICATION_ERROR_MESSAGE != null}">
		          <c:out value="${AUTHENTICATION_ERROR_MESSAGE}"/> 
...
<div style="text-align:center;margin:20px 0; font:normal 14px/24px 'MicroSoft YaHei';">
 © 上海理家物业管理有限公司 All Rights Reserved      
</div>
</body>
</html>